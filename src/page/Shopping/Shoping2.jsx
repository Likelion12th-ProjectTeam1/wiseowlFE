...
import MenuCategoryTwo from "./components/MenuCategory";
...
export default function ShoppingTwo() {
  const facility_num = "8gz";
    ...
    <Container>
      {loading ? (
        ...
        <>
          ...
          <BottomBox>
            <MenuCategoryTwo data={data.products} />
          </BottomBox>
        </>
      ) : (
        <p>데이터를 불러오지 못했습니다.</p>
